...
export default function TarotPage() {
  ...
  const faqs = [
    { q: 'Как работает расклад таро с AI?', a: 'Вы задаёте вопрос, AI-консультант Селена вытягивает карты из колоды 78 арканов Rider-Waite и даёт персональную интерпретацию именно для вашей ситуации.' },
    ...
    { q: 'Сколько карт в раскладе?', a: 'Селена адаптирует расклад под вопрос: 1 карта для простого ответа, 3 карты для ситуации (прошлое/настоящее/будущее), 5 карт для глубокого анализа.' },
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        ::-webkit-scrollbar{width:3px}::-webkit-scrollbar-thumb{background:rgba(201,168,76,0.3);border-radius:2px}
      ...
      <div style={{position:'fixed',inset:0,zIndex:0,pointerEvents:'none',overflow:'hidden'}}>
        ...
        <div style={{position:'absolute',top:'-10%',left:'30%',width:'60vw',height:'60vw',maxWidth:'700px',borderRadius:'50%',background:'radial-gradient(circle,rgba(201,168,76,0.08) 0%,transparent 70%)'}}/>
      </div>
      ...
      <div style={{position:'relative',zIndex:10}}>
        ...
        <section style={{padding:'80px 52px 100px',maxWidth:'1200px',margin:'0 auto'}} className="pad">
          <div className="hero-grid" style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'60px',alignItems:'center'}}>
            <div style={{animation:'fadeUp 0.7s ease both'}}>
              <div style={{fontFamily:'"Lora",serif',fontSize:'13px',fontStyle:'italic',letterSpacing:'2px',color:'rgba(201,168,76,0.6)',marginBottom:'16px',textTransform:'uppercase'}}>Консультация с ИИ</div>
              <h1 style={{fontFamily:'"Playfair Display",serif',fontSize:'clamp(36px,5vw,64px)',fontWeight:900,color:'#FFFFFF',lineHeight:1.1,marginBottom:'20px'}}>
                Таро<br/><span style={{color:'rgba(201,168,76,0.9)'}}>Расклад</span><br/>на любой вопрос
              </h1>
              <p style={{fontFamily:'"Lora",serif',fontSize:'17px',lineHeight:1.85,color:'rgba(210,200,245,0.65)',marginBottom:'36px'}}>
                Селена — мастер таро с доступом к 78 арканам колоды Rider-Waite. Задайте любой вопрос о любви, карьере, деньгах или духовном пути — карты откроют скрытое.
              </p>
              <div style={{display:'flex',gap:'14px',flexWrap:'wrap',marginBottom:'32px'}}>
                <Link href="/auth/register" style={{padding:'14px 32px',borderRadius:'8px',background:'linear-gradient(135deg,rgba(201,168,76,0.9),rgba(201,168,76,0.65))',fontFamily:'"Playfair Display",serif',fontSize:'14px',fontWeight:700,color:'#0C0818',textDecoration:'none',letterSpacing:'0.5px',boxShadow:'0 4px 24px rgba(201,168,76,0.35)'}}>
                  Начать бесплатно
                </Link>
                <Link href="#how" style={{padding:'14px 28px',borderRadius:'8px',border:'1px solid rgba(201,168,76,0.3)',fontFamily:'"Playfair Display",serif',fontSize:'14px',fontWeight:700,color:'rgba(201,168,76,0.8)',textDecoration:'none'}}>
                  Как это работает
                </Link>
              </div>
              <div style={{display:'flex',gap:'28px'}}>
                {[['78','арканов'],['3-5','карт в раскладе'],['5','бесплатных сообщений']].map(([v,l])=>(
                  <div key={l}>
                    <div style={{fontFamily:'"Playfair Display",serif',fontSize:'22px',fontWeight:800,color:'rgba(201,168,76,0.9)'}}>{v}</div>
              ...
              <div style={{position:'relative',width:'280px',height:'420px'}}>
                {[{r:-12,y:-20,x:-30,z:0},{r:6,y:-10,x:20,z:1},{r:0,y:0,x:0,z:2}].map((c,i)=>(
                  <div key={i} style={{
                    ...
                    zIndex:c.z,
                    background:'linear-gradient(145deg,rgba(201,168,76,0.15),rgba(60,20,100,0.8))',
                    ...
                    {i===2 && <div style={{textAlign:'center'}}>
                      ...
                      <div style={{fontFamily:'"Playfair Display",serif',fontSize:'22px',fontWeight:900,color:'rgba(201,168,76,0.9)'}}>Таро</div>
                      <div style={{fontFamily:'"Lora",serif',fontSize:'13px',fontStyle:'italic',color:'rgba(201,168,76,0.5)',marginTop:'6px'}}>78 арканов</div>
                    </div>}
                  </div>
                ))}
              </div>
          ...
          <div style={{maxWidth:'1000px',margin:'0 auto'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'24px'}}>
              {[
                ...
                {num:'02',icon:'🃏',title:'Карты открываются',desc:'Селена вытягивает карты специально для вашей ситуации. Каждая карта — это зеркало вашей реальности.'},
                ...
                <div key={i} style={{padding:'28px',background:'rgba(255,255,255,0.03)',border:'1px solid rgba(201,168,76,0.12)',borderRadius:'14px',position:'relative',overflow:'hidden'}}>
                  <div style={{position:'absolute',top:0,left:0,right:0,height:'2px',background:'linear-gradient(90deg,transparent,rgba(201,168,76,0.5),transparent)'}}/>
                  <div style={{fontFamily:'"Playfair Display",serif',fontSize:'11px',letterSpacing:'3px',color:'rgba(201,168,76,0.4)',marginBottom:'14px'}}>{s.num}</div>
        ...
        <section style={{padding:'80px 52px'}} className="pad">
          <div style={{maxWidth:'1000px',margin:'0 auto'}}>
            <h2 style={{fontFamily:'"Playfair Display",serif',fontSize:'clamp(24px,3.5vw,40px)',fontWeight:900,color:'#FFFFFF',marginBottom:'40px',textAlign:'center'}}>Что умеет Селена</h2>
        ...
        <section style={{padding:'80px 52px',background:'rgba(255,255,255,0.02)'}} className="pad">
          <div style={{maxWidth:'600px',margin:'0 auto',textAlign:'center'}}>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'16px',marginBottom:'24px'}}>
              <div style={{padding:'28px',background:'rgba(201,168,76,0.05)',border:'1px solid rgba(201,168,76,0.2)',borderRadius:'14px'}}>
                <div style={{fontFamily:'"Playfair Display",serif',fontSize:'14px',letterSpacing:'2px',color:'rgba(201,168,76,0.6)',marginBottom:'8px',textTransform:'uppercase'}}>Initiate</div>
                ...
                <Link href="/auth/register" style={{display:'block',padding:'11px',textAlign:'center',borderRadius:'8px',background:'rgba(201,168,76,0.15)',border:'1px solid rgba(201,168,76,0.3)',fontFamily:'"Playfair Display",serif',fontSize:'12px',fontWeight:700,color:'rgba(201,168,76,0.9)',textDecoration:'none',letterSpacing:'0.5px'}}>Выбрать</Link>
              </div>
            ...
            <div style={{display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:'16px'}}>
              {reviews.map((r,i)=>(
                <div key={i} style={{padding:'24px',background:'rgba(255,255,255,0.025)',border:'1px solid rgba(201,168,76,0.1)',borderRadius:'14px'}}>
                  <div style={{color:'rgba(201,168,76,0.8)',fontSize:'16px',marginBottom:'12px'}}>★★★★★</div>
                  ...
                  <div style={{fontFamily:'"Playfair Display",serif',fontSize:'13px',fontWeight:700,color:'rgba(201,168,76,0.7)'}}>{r.name}</div>
        ...
        <section style={{padding:'100px 52px',textAlign:'center'}} className="pad">
          <div style={{maxWidth:'600px',margin:'0 auto'}}>
            ...
            <Link href="/auth/register" style={{display:'inline-block',padding:'16px 40px',borderRadius:'8px',background:'linear-gradient(135deg,rgba(201,168,76,0.9),rgba(201,168,76,0.65))',fontFamily:'"Playfair Display",serif',fontSize:'16px',fontWeight:700,color:'#0C0818',textDecoration:'none',letterSpacing:'0.5px',boxShadow:'0 4px 30px rgba(201,168,76,0.35)'}}>
              Начать бесплатно →
            </Link>
          </div>
        </section>
