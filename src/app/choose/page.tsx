...
const MODULES = [
  ...
  { key:'destiny', name:'Матрица Судьбы', sub:'Кармические задачи и таланты', icon:'🔯', color:'rgba(255,120,180,1)', glow:'rgba(255,120,180,0.15)', desc:'Цифровой код вашей даты рождения раскрывает кармические задачи, скрытые таланты и главное предназначение в этой жизни.', href:'/chat/destiny' },
]
